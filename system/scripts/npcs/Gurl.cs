...
public class Denmark : NpcScript
{
	public override void Load()
	{
       SetName("Chibi Denmark");
        SetRace(10002);
        SetBody(height: 0.01f);
        SetFace(skinColor: 20, eyeType: 19, eyeColor: 1, mouthType: 18);
        SetStand("human/female/anim/female_natural_stand_npc_dilys");
		SetLocation(1, 13143, 38128, 106);
		
        EquipItem(Pocket.Face, 4900, 0x00FFDC53, 0x00FFB682, 0x00A8DDD3);
        EquipItem(Pocket.Hair, 4131, 0xE8CD00);
        EquipItem(Pocket.Armor, 15252, 0xFF0000, 0x000000, 0x000000);
