	...
	public class GmCommandManager : CommandManager<GmCommand, GmCommandFunc>
	{
		...
		private CommandResult HandleAllSkills(ChannelClient client, Creature sender, Creature target, string message, IList<string> args)
		{
			...
			var listOfSkills = new SkillId[] {
				...
				SkillId.ManaShield, 
				SkillId.Composing,
                SkillId.PlayingInstrument,
                SkillId.Song,
                SkillId.Windmill,
                SkillId.Icebolt,
                SkillId.Firebolt,
                SkillId.Lightningbolt,
                SkillId.MeleeCounterattack,
                SkillId.FirstAid,
                SkillId.ArrowRevolver,
                SkillId.MagnumShot,
                SkillId.RangedAttack,
                SkillId.SupportShot,
                SkillId.AwakeningofLight,
                SkillId.DemonOfPhysis,
                SkillId.FuryOfConnous,
                SkillId.SoulOfChaos,
                SkillId.SpiritOfOrder,
                SkillId.MindofChaos,
                SkillId.PowerofOrder,
                SkillId.EyeofOrder,
                SkillId.SwordofOrder,
                SkillId.HandsofChaos,
                SkillId.ControlofDarkness,
                SkillId.BodyofChaos,
                SkillId.ShieldofPhysis,
                SkillId.SpellofPhysis,
                SkillId.LifeofPhysis,
                SkillId.ArmorofConnous,
                SkillId.MindofConnous,
                SkillId.SharpnessofConnous,
